...
import logo from '../public/images/veritext_logo_reverse.png';
...
const Login = ({ callback }) => {
  ...
  async function handleSubmit(e) {
    ...
    if (username && password) {
      ...
      try {
        ...
        // console.dir('ERROR: ', e)
        // openSnackbar(
        //   'Something went wrong, please re-enter credentials and try again.',
        //   true
        // );
      }
    } else {
  ...
  const DecorativeWelcomeText = (
    <DecorativeWelcomeTextContainer>
      <StyledTypography variant='h5'>Vision</StyledTypography>
    </DecorativeWelcomeTextContainer>
  );
      ...
      <Box
        ...
        <StyledPaper square elevation={0}>
          <Box
            ...
            <Image width={150} height={60} src={logo} alt='Veritext Logo' />
          </Box>
